...
export class ComixFilter {
  ...
  getDefaultContentRatingSettings() {
    return (Application.getState("content_rating") as string[] | undefined) ??
      ["suggestive"];
  }
  ...
  getYearSettings() {
    return (
      (Application.getState("year_settings") as number | undefined) ??
  ...
  getChapterSectionDiffType() {
    return (Application.getState("chapterSection") as boolean | undefined) ??
      false;
  }
  ...
  getTrendingSectionDiffType() {
    return (Application.getState("trendingSection") as boolean | undefined) ??
      true;
  }
  ...
  getRecentSectionDiffType() {
    return (Application.getState("recentSection") as boolean | undefined) ??
      true;
  }
