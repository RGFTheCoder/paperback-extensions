...
//
//   deno run -A experiment/crypto-pipeline/generate.ts
...
function genDecrypt(c: Constants) {
  const stages = JSON.stringify(
    c.stages.map((s) => ({ sboxB64: s.sboxB64, keyB64: s.keyB64, iv: s.iv })),
    null,
    4,
  );
  return `/* Generated by experiment/crypto-pipeline/generate.ts. DO NOT EDIT BY HAND.
...
function genSigner(c: Constants) {
  const stages = JSON.stringify(
    c.stages.map((s) => ({ sboxB64: s.sboxB64, keyB64: s.keyB64, iv: s.iv })),
    null,
    4,
...
export function generate() {
  ...
  return {
    decryptPath: DECRYPT_OUT,
    signerPath: SIGNER_OUT,
    bundleId: c.bundleId,
  };
}
